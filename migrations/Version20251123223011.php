 ...
 */
final class Version20251123223011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id SERIAL NOT NULL, user_id_id INT NOT NULL, public_id VARCHAR(100) NOT NULL, is_default BOOLEAN NOT NULL, is_professionnal BOOLEAN NOT NULL, street VARCHAR(255) NOT NULL, zipcode VARCHAR(20) NOT NULL, city VARCHAR(100) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE image (id SERIAL NOT NULL, product_variant_id_id INT NOT NULL, folder_name VARCHAR(50) NOT NULL, image_name VARCHAR(10) NOT NULL, format VARCHAR(15) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE order_product (id SERIAL NOT NULL, order_id_id INT NOT NULL, product_variant_id_id INT NOT NULL, price INT NOT NULL, quantity SMALLINT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE product_variant (id SERIAL NOT NULL, product_id_id INT NOT NULL, wood_id_id INT NOT NULL, uuid UUID NOT NULL, public_id VARCHAR(100) NOT NULL, is_default BOOLEAN NOT NULL, price INT DEFAULT NULL, stock INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, uuid VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(150) NOT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
